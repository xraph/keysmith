...
func keyToModel(k *key.Key) *keyModel {
	m := &keyModel{
		...
		Metadata:    jsonbObject(k.Metadata),
...
func policyToModel(pol *policy.Policy) *policyModel {
	return &policyModel{
		...
		AllowedScopes:   jsonbArray(pol.AllowedScopes),
		AllowedIPs:      jsonbArray(pol.AllowedIPs),
		AllowedOrigins:  jsonbArray(pol.AllowedOrigins),
		AllowedMethods:  jsonbArray(pol.AllowedMethods),
		AllowedPaths:    jsonbArray(pol.AllowedPaths),
		...
		Metadata:        jsonbObject(pol.Metadata),
...
func scopeToModel(sc *scope.Scope) *scopeModel {
	m := &scopeModel{
		...
		Metadata:    jsonbObject(sc.Metadata),
...
func usageToModel(rec *usage.Record) *usageModel {
	return &usageModel{
		...
		Metadata:   jsonbObject(rec.Metadata),
