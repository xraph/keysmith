      ...
      <div className="relative container max-w-(--fd-layout-width) mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="mt-4 text-lg text-fd-muted-foreground leading-relaxed">
            Add API key management to your Go service in minutes. Keysmith
            handles key generation, hash storage, tenant isolation, policy
            enforcement, and usage analytics out of the box.
          </p>
