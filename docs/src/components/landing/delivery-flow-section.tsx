...
// ─── Cycling Key Action ────────────────────────────────────
const pipelineActions = ["key.create", "key.validate", "key.rotate"];

function CyclingKeyAction() {
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex flex-col items-start gap-2.5">
            ...
            <EventRow
              ...
              statusLabel={phase === 1 ? "&#10003; Active" : "&#8635; Checking"}
...
// ─── Key Lifecycle Pipeline Section ─────────────────────────
      ...
      <div className="container max-w-(--fd-layout-width) mx-auto px-4 sm:px-6">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center">
          ...
          <div className="flex flex-col">
            <SectionHeader
              badge="Key Lifecycle Pipeline"
              title="From creation to validation."
              description="Keysmith orchestrates the entire API key lifecycle — hashing, tenant scoping, policy enforcement, scope checking, and usage recording."
              align="left"
            />

            <div className="mt-8 space-y-5">
              <FeatureBullet
                title="SHA-256 Hash Storage"
                description="Raw API keys are never stored. Only SHA-256 hashes are persisted, and raw keys are returned exactly once at creation time. Constant-time comparison prevents timing attacks."
                delay={0.2}
              />
              <FeatureBullet
                title="Zero-Downtime Rotation"
                description="Rotate keys with configurable grace periods. Both old and new keys validate during the grace window, giving clients time to migrate without service interruption."
                delay={0.3}
              />
              <FeatureBullet
                title="Lifecycle Hook Plugins"
                description="Every key event fires lifecycle hooks to registered plugins. Built-in plugins provide audit trails, metrics counters, and Warden authorization sync."
                delay={0.4}
              />
            </div>
