...
const footerLinks = {
  ...
  Subsystems: [
    { label: "Keys", href: "/docs/subsystems/keys" },
    { label: "Policies", href: "/docs/subsystems/policies" },
    { label: "Scopes", href: "/docs/subsystems/scopes" },
    { label: "Usage Analytics", href: "/docs/subsystems/usage" },
  ...
  Community: [
    ...
    {
      label: "Issues",
      href: "https://github.com/xraph/keysmith/issues",
      external: true,
    },
    {
      label: "Discussions",
      href: "https://github.com/xraph/keysmith/discussions",
      external: true,
    },
    {
      label: "Contributing",
      href: "https://github.com/xraph/keysmith/blob/main/CONTRIBUTING.md",
      external: true,
    },
  ],
};
        ...
        <div className="grid grid-cols-2 gap-8 py-12 sm:py-16 md:grid-cols-5 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="inline-flex items-center gap-2 mb-4">
              <ThemedLogo />
              <span className="font-bold text-lg">Keysmith</span>
            </Link>
            <p className="text-sm text-fd-muted-foreground leading-relaxed max-w-xs">
              Composable API key management for Go. Generate, validate, rotate,
              and revoke keys with tenant isolation and usage analytics.
            </p>
            {/* Social links */}
