...
// ─── Mini Key Lifecycle Diagram ───────────────────────────
function MiniKeyLifecycleDiagram() {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      <div className="relative space-y-6 p-4">
        ...
        <div className="flex items-center justify-center gap-0">
          ...
          <FlowNode label="Validate" color="amber" size="sm" delay={1.0} />
        ...
        <div className="flex items-start justify-center">
          <div className="space-y-2.5">
            ...
            >
              ...
              <StatusBadge status="delivered" label="hashed" />
            </motion.div>

            {/* Event 2: key validated */}
            <motion.div
              initial={{ opacity: 0, x: -10 }}
              animate={{ opacity: 1, x: 0 }}
            ...
            >
              ...
              <StatusBadge status="retry" label="active" />
            </motion.div>
            ...
            >
              ...
              <StatusBadge status="delivered" label="tracked" />
            </motion.div>
          </div>
        </div>
        ...
        <div className="flex flex-wrap items-center justify-center gap-2 pt-2">
          <FloatingBadge label="SHA-256" delay={1.6} />
      ...
      <div className="relative container max-w-(--fd-layout-width) mx-auto px-4 sm:px-6">
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 items-center py-20 sm:py-28 md:py-32">
          ...
          <div className="flex flex-col items-start">
            ...
            >
              API key generation, validation, rotation, revocation, scoped
              permissions, usage analytics, and policy enforcement &mdash;
              tenant-scoped, plugin-extensible, and composable.
            </motion.p>
            ...
            >
              ...
              <a
                href="https://github.com/xraph/keysmith"
                target="_blank"
                rel="noreferrer"
                className={cn(
          ...
          {/* Right: Mini Key Lifecycle diagram */}
          <div className="relative lg:pl-8">
            <MiniKeyLifecycleDiagram />
          </div>
        </div>
      </div>
    </section>
